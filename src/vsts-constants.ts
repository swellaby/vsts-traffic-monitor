...
/**
 * Azure AD user subject subtype.
 */
export const aadGraphSubjectType = 'aad';

/**
 * Microsoft account subject subtype.
 */
export const msaGraphSubjectType = 'msa';

/**
 * VSTS service account subject subtype.
 */
export const svcGraphSubjectType = 'svc';

/**
 * Imported account subject subtype.
 */
